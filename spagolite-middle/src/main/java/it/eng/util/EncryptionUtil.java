...
public class EncryptionUtil {
    ...
    public static byte[] aesCrypt(String plainText, Aes bit) {
        ...
        try {
            ...
            SecretKey secretKey = new SecretKeySpec(decodeBase64(chiave.getBytes(StandardCharsets.UTF_8)), "AES");
            byte[] iv = new byte[12];
            ...
            cipherMessage = byteBuffer.array();
                ...
                | BadPaddingException | InvalidKeyException | IllegalBlockSizeException ex) {
    ...
    public static void main(String[] args) {
        ...
        Logger.getLogger(EncryptionUtil.class.getName()).log(Level.INFO, "Stringa   originale: TangerineDream");
    ...
    /**
     * Metodo di utilità  per generare delle chiavi Base64 UTF-8 da mettere come costanti in questa classe
     */

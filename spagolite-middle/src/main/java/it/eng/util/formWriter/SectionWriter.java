...
public class SectionWriter extends ElementWriter<Section> {
    ...
    private void writeAdds(Writer writer) throws IOException {
        // writer.write(" addComponent(new Section(this, " +
        // getConstantName().toLowerCase() + ", \"" +
        // getElement().getDescription() + "\", " + getElement().getLegend() + ", " +
        // getElement().getHidden() + ", " +
        // getElement().getBorderHidden() + ", "+ getElement().getShowButton() + ",
        // "+getElement().getLoadOpened()+"));\n");
        String legend = StringUtils.isBlank(getElement().getLegend()) ? "null"
                : "\"" + getElement().getLegend() + "\"";
    ...
    private void writeGets(Writer writer) throws IOException {
        ...
        writer.write(
                "      return (Section) getComponent(" + getConstantName().toLowerCase() + ");\n");
        writer.write("    }\n");
        writer.write("\n");
    ...
    public void write(Writer writer) throws IOException {
        writer.write("  public static class " + ClassUtil.getClassName(getElement().getName())
                + " extends Section {\n");
        writer.write("\n");

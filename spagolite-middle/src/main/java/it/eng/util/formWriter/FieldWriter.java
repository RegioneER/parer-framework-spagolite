...
public class FieldWriter extends ElementWriter<Field> {
    ...
    public void writeAdd(Writer writer) throws IOException {
        ...
        String format = getElement().getFormat() == null ? "null" : "\"" + getElement().getFormat() + "\"";
        ...
        if (getElement() instanceof Input) {
            ...
            String forceCase = input.getForceCase() != null ? "ForceCase." + input.getForceCase() : "null";
            String forceTrim = input.getForceCase() != null ? "ForceTrim." + input.getForceTrim() : "null";
            String regExp = input.getRegExp() != null ? "\"" + input.getRegExp() + "\"" : "null";
            String groupingDecimal = input.isSetGroupingDecimal() ? "" + input.getGroupingDecimal() : "false";
            String tooltip = input.getTooltip() != null ? "\"" + input.getTooltip() + "\"" : "null";

            writer.write("      addComponent(new Input" + getDataType() + "(this, " + getConstantName().toLowerCase()
                    + ", \"" + description + "\", \"" + alias + "\"," + type + ", " + format + ", " + groupingDecimal
                    + ", " + input.getRequired() + ", " + input.getHidden() + ", " + input.getReadonly() + ", "
                    + input.getTrigger() + ", " + input.getMaxLength() + ", " + forceCase + ", " + forceTrim + ", "
                    + regExp + ", " + tooltip + "));\n");
            ...
            boolean withsearchcomp = comboBox.isSetWithSearchComp() ? comboBox.getWithSearchComp() : false;
            writer.write("      addComponent(new ComboBox" + getDataType() + "(this, " + getConstantName().toLowerCase()
                    + ", \"" + description + "\", \"" + alias + "\"," + type + ", " + format + ", "
                    + comboBox.getRequired() + ", " + comboBox.getHidden() + ", " + comboBox.getReadonly() + ", "
                    + comboBox.getTrigger() + ", " + comboBox.getMaxLength() + ", " + addBlank + ", " + withsearchcomp
                    + "));\n");
        } else if (getElement() instanceof CheckBox) {
            CheckBox checkBox = (CheckBox) getElement();
            String defaultValue = checkBox.isSetDefaultValue() ? "\"" + checkBox.getDefaultValue().toString() + "\""
                    : null;
            String tooltip = checkBox.getTooltip() != null ? "\"" + checkBox.getTooltip() + "\"" : "null";
            if (StringUtils.isNotBlank(defaultValue)) {
                writer.write(
                        "      addComponent(new CheckBox" + getDataType() + "(this, " + getConstantName().toLowerCase()
                                + ", \"" + description + "\", \"" + alias + "\"," + type + ", " + format + ", "
                                + checkBox.getRequired() + ", " + checkBox.getHidden() + ", " + checkBox.getReadonly()
                                + ", " + checkBox.getTrigger() + ", " + defaultValue + ", " + tooltip + "));\n");
            } else {
                writer.write("      addComponent(new CheckBox" + getDataType() + "(this, "
                        + getConstantName().toLowerCase() + ", \"" + description + "\", \"" + alias + "\"," + type
                        + ", " + format + ", " + checkBox.getRequired() + ", " + checkBox.getHidden() + ", "
                        + checkBox.getReadonly() + ", " + checkBox.getTrigger() + ", " + tooltip + "));\n");
            }
        } else if (getElement() instanceof MultiSelect) {
            MultiSelect multiSelect = (MultiSelect) getElement();
            writer.write("      addComponent(new MultiSelect(this, " + getConstantName().toLowerCase() + ", \""
                    + description + "\", \"" + alias + "\"," + type + ", " + format + ", " + multiSelect.getRequired()
            ...
            writer.write("      addComponent(new TextArea" + getDataType() + "(this, " + getConstantName().toLowerCase()
                    + ", \"" + description + "\", \"" + alias + "\"," + type + ", " + format + ", "
                    + textArea.getRequired() + ", " + textArea.getHidden() + ", " + textArea.getReadonly() + ", "
            ...
            writer.write("      addComponent(new Button(this, " + getConstantName().toLowerCase() + ", \"" + description
                    + "\", \"" + alias + "\"," + type + ", " + format + ", " + button.getRequired() + ", "
                    + button.getHidden() + ", " + button.getReadonly() + ", " + button.getTrigger() + ","
                    + button.getDisableHourGlass() + "," + button.getSecure() + "));\n");
        } else if (getElement() instanceof Radio) {
            Radio radio = (Radio) getElement();
            writer.write("      addComponent(new Radio(this, " + getConstantName().toLowerCase() + ", \"" + description
                    + "\", \"" + alias + "\"," + type + ", " + format + ", " + radio.getRequired() + ", "
                    + radio.getHidden() + ", " + radio.getReadonly() + ", " + radio.getTrigger() + ", \""
                    + radio.getGroupName() + "\"));\n");
            ...
            writer.write("      addComponent(new Semaphore(this, " + getConstantName().toLowerCase() + ", \""
                    + description + "\", \"" + alias + "\"," + type + ", " + format + ", " + semaphore.getRequired()
                    + ", " + semaphore.getHidden() + ", " + semaphore.getReadonly() + ", " + semaphore.getTrigger()
                    + "," + semaphore.getState() + "));\n");
        } else if (getElement() instanceof ButtonList) {
            ButtonList buttonList = (ButtonList) getElement();
            writer.write("      addComponent(new ButtonList(this, " + getConstantName().toLowerCase() + ", \""
            ...
            writer.write("      addComponent(new MultiSemaphore(this, " + getConstantName().toLowerCase() + ", \""
                    + description + "\", \"" + alias + "\"," + type + ", " + format + ", " + element.getRequired()
                    + ", " + element.getHidden() + ", " + element.getReadonly() + ", " + element.getTrigger() + ", "
                    + element.getGreenChecked() + ", " + element.getYellowChecked() + ", " + element.getRedChecked()
                    + "));\n");
            ...
            if (StringUtils.isNotBlank(link.getExternalLinkParamApplic())) {
                ...
                externalLink = ", \"" + link.getExternalLinkParamApplic() + "\", " + externalLinkParamId;
            }
            String genericLinkId = StringUtils.isBlank(link.getGenericLinkId()) ? "(String) null"
                    : "\"" + link.getGenericLinkId() + "\"";
            writer.write("      addComponent(new Link(this, " + getConstantName().toLowerCase() + ", \"" + description
                    + "\", \"" + alias + "\"," + type + ", " + format + ", " + link.getRequired() + ", "
                    + link.getHidden() + ", " + link.getReadonly() + ", " + link.getTrigger() + ", \""
                    + link.getTarget() + "\", \"" + link.getTooltip() + "\", " + link.getIsTargetList() + ", "
                    + visibility + externalLink + "," + genericLinkId + "));\n");
        }
    }

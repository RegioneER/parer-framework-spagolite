...
public class TableSectionTag extends BaseFormTag<Section> {
    ...
    // private static final String IMG_TITLE = "clicca sul pulsante per espandere o
    // nascondere la sezione";
    ...
    private String getCompleteLegend(Section section) {
        ...
        return " <span class=\"tablesection " + (section.isLoadOpened() ? "opened" : "closed")
                + "\"><b>" + section.getLegend() + "</b></span>";
    }

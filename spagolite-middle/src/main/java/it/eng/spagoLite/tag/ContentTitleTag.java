...
public class ContentTitleTag extends BaseSpagoLiteTag {
    ...
    /*
     * Questo parametro serve ad indicare che il tag deve costruire una chiamata all'help sia nel caso in cui ci sia un
     * help associato alla pagina sia se c'è un help associato al menu.
     */
    ...
    public int doStartTag() throws JspException {
        ...
        /*
         * Viene fatto un controllo che l'utente esista (nella pagina del cambio password per esempio non esiste). Se
         * l'utente non esiste chiude il tag senza fare altro.
         */
        if (utente != null) {
            ...
            if (utente.getProfile() != null
                    && (paginaSelezionata = (Pagina) utente.getProfile().getChild(nuovaPagina)) != null
                ...
                if (codiceMenu != null && !codiceMenu.trim().equals("")) {
                    /*
                     * Se il menu associato a questo tag è presente tra ii menu associati alla pagina selezionata allora
                     * attiva l'Help con il codice di menu' per dispenser.
                     */

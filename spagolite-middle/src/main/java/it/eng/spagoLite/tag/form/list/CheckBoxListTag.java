            ...
            if (table != null) {
                ...
                for (Object object : table) {
                    if (table.getPageSize() <= 0 || (i >= table.getFirstRowPageIndex()
                        ...
                        String singleSelection = (getSingleSelection()) ? "singleSelection"
                                : "multipleSelection";
                        // Campo che contiene i checkBox button
                        ...
                        if (getComponent().getStatus().equals(Status.view)) {
                            ...
                            writeln("   <td class=\"" + className + "\"><input type=\"checkBox\" "
                                    + checked + " name=\"" + getName() + i
                                    + "_checkBox\" value=\"S\" type=\"" + singleSelection
                                    + "\"/></td>");

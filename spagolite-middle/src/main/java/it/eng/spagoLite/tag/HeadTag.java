...
public class HeadTag extends BaseSpagoLiteTag {
    ...
    /*
     * in caso di pagina inclusa in un'altra e non si vogliono ri-caricare le risorse js per evitare
     * problemi
     */
	...
	css.append("  <link href=\"" + contextPath
		+ "/css/slForms.css\" rel=\"stylesheet\" type=\"text/css\" />\n");

	css.append("  <link href=\"" + contextPath
		+ configSingleton.getStringValue(CSS_OVER_RELATIVE.name())
	...
	if (StringUtils.isNotBlank(configSingleton.getStringValue(TITOLO_APPLICATIVO.name()))) {
	    ...
	    localTitle.append("  <title> [")
		    .append(configSingleton.getStringValue(TITOLO_APPLICATIVO.name())).append("] ")
		    .append(titleHtml).append("</title>\n");
	} else {
	...
	localTitle.append("  <link rel=\"shortcut icon\" type=\"image/x-icon\" href=\"")
		.append(contextPath)
	 ...
	 */
	js.append("  <script type=\"text/javascript\" src=\"" + contextPath
		+ "/js/sips/classes.js\"></script>\n");

	js.append("  <script type=\"text/javascript\" src=\"" + contextPath
		+ "/js/sips/main.js\"></script>\n");
	...
	// Internal script
	js.append("  <script type=\"text/javascript\" src=\"" + contextPath
		+ "/js/help/globalsetup.js\"></script>\n");

	js.append("  <script type=\"text/javascript\" src=\"" + contextPath
		+ "/js/help/help.js\"></script>\n");

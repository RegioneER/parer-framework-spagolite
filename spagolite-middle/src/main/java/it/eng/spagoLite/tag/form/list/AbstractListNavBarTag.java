...
public class AbstractListNavBarTag extends AbstractListTag {
    ...
    private static final int[] pageSizes = {
            10, 20, 50, 100 };
    ...
    protected void writeFirst() throws JspException {
        ...
        if (table != null) {
            if (!modificainCorso() && table.getCurrentPageIndex() > 1) {
                ...
                writeln(getLink("navBarFirstPageLink", ListAction.NE_FIRST, "", null,
                        "Vai alla prima pagina", -1, false, true, getMainNavTable()));
    ...
    // <span> <a href="#">10</a>&nbsp;<a href="#">20</a>&nbsp;<a
    // href="#">50</a>&nbsp;<a href="#">100</a></span></div>
        ...
        if (table != null && table.size() > 0) {
            ...
            for (int ps : pageSizes) {
                if (ps != pagesize) {
                    ...
                    writeln(getLink("", ListAction.NE_SET_PAGE_SIZE, "", "" + ps,
                            ps + " record per pagina", ps, false, true, getMainNavTable()));
                } else {
    ...
    protected void writePrevPage() throws JspException {
        ...
        if (table != null) {
            if (!modificainCorso() && table.getCurrentPageIndex() > 1) {
                ...
                writeln(getLink("navBarPrevPageLink", ListAction.NE_PREV_PAGE, "", null,
                        "Vai alla pagina precedente", -1, false, true, getMainNavTable()));
    ...
    protected void writePrev() throws JspException {
        ...
        enabled = (table.getLazyListInterface() != null)
                ? (enabled || table.getLazyListInterface().getFirstResult() > 0)
                : enabled;
        if (table != null) {
            if (!modificainCorso() && enabled) {
                // writeLink(ListAction.NE_PREV, PREV);
                writeln(getLink("navBarPrevLink", ListAction.NE_PREV, "", null,
                        "Vai al record precedente", -1, false, true, getMainNavTable()));

            } else {
                // writeLink(null, PREV_DISABLED);
                writeln(getLink("navBarPrevDisabledLink", null, null, null, null, -1, false, true,
                        getMainNavTable()));
    ...
    protected void writeElenco() throws JspException {
        ...
        if (table != null) {
            if (!modificainCorso()) {
                ...
                writeln(getLink("navBarBackLink", ListAction.NE_ELENCO, "", "Indietro", "Indietro",
                        -1, false, true, getMainNavTable()));
            } else {
                // writeLink(null, BACK_DISABLED, "");
                writeln(getLink("navBarBackDisabledLink", null, null, null, null, -1, false, true,
                        getMainNavTable()));
    ...
    protected void writeNext() throws JspException {
        ...
        boolean enabled = (table.getLazyListInterface() != null)
                ? table.getCurrentRowIndex()
                        + table.getLazyListInterface().getFirstResult() < table.fullSize() - 1
                : table.getCurrentRowIndex() < table.size() - 1;
        if (table != null) {
            if (!modificainCorso() && enabled) {
                // writeLink(ListAction.NE_NEXT, NEXT);
                writeln(getLink("navBarNextLink", ListAction.NE_NEXT, "", null,
                        "Vai al record successivo", -1, false, true, getMainNavTable()));

            } else {
                // writeLink(null, NEXT_DISABLED);
                writeln(getLink("navBarNextDisabledLink", null, null, null, null, -1, false, true,
                        getMainNavTable()));
    ...
    protected void writeNextPage() throws JspException {
        BaseTableInterface<?> table = getComponent().getTable();
        if (table != null) {
            if (!modificainCorso() && table.getPageSize() > 0
                    && table.getCurrentPageIndex() < table.getPages()) {
                writeln(getLink("navBarNextPageLink", ListAction.NE_NEXT_PAGE, "", null,
                        "Vai alla pagina successiva", -1, false, true, getMainNavTable()));
            }
        }
    }
    ...
    protected void writeLast() throws JspException {
        ...
        if (table != null) {
            if (!modificainCorso() && table.getPageSize() > 0
                ...
                writeln(getLink("navBarLastPageLink", ListAction.NE_LAST, "", null,
                        "Vai all'ultima pagina", -1, false, true, getMainNavTable()));
        ...
        if (table != null && table.size() > 0) {
            if (table.getLazyListInterface() != null) {
                writeln("<span class=\"listLabel\">Record "
                        + (table.getCurrentRowIndex()
                                + table.getLazyListInterface().getFirstResult() + 1)
                        + " di " + table.fullSize() + "</span>");
            } else {
                writeln("<span class=\"listLabel\">Record " + (table.getCurrentRowIndex() + 1)
                        + " di " + table.fullSize() + "</span>");
            }
        }
    }
        ...
        if (table != null && table.size() > 0) {
            ...
            if (!isListInMemory() && !isLazySortEnabled()) {
                writeln("<span class=\"listLabel\">Lista non ordinabile (superati i "
                        + getComponent().getTable().getLazyListInterface().getMaxResult()
                        + " record)</span>");
    ...
    protected void writePageCounter() throws JspException {
        ...
        if (table != null && table.getPageSize() > 0 && table.size() > 0) {
            writeln("<span class=\"listLabel\">Pagina " + (table.getCurrentPageIndex()) + " di "
                    + table.getPages() + "</span>");
        }
    }
    ...
    protected void writeExcel() throws JspException {
        BaseTableInterface<?> table = getComponent().getTable();
        if (table != null && table.getPageSize() > 0 && table.size() > 0) {
            // writeln("<span class=\"floatRight\">" + getLink(ListAction.NE_EXPORT_XLS,
            // EXPORT_XLS, "") + "</span>");
            // writeln("<span class=\"floatRight\">" + getLink("navBarExportExcelLink",
            // ListAction.NE_EXPORT_XLS, "",
            // "Excel", "Esporta la lista in excel", -1, false,true,getMainNavTable()) +
            // "</span>");
            writeln("<span class=\"floatRight\">" + getLink("", ListAction.NE_EXPORT_XLS, EXCEL_IMG,
                    null, null, -1, false, true, getMainNavTable()) + "</span>");
        }
    }
    ...
    /*
     * i metodi qui sotto non dipendono solo dal fatto che il componente sia o meno modificabile ma
     * anche dai permessi associati all'utente
     */
    ...
    protected void writeInsert() throws JspException {
        ...
        if (table != null && table.getPageSize() > 0) {
            writeln("<span class=\"floatRight\">" + getLink("", ListAction.NE_DETTAGLIO_INSERT,
                    INSERT_IMG, null, null, -1, false, true, getMainNavTable()) + "</span>");
        }
    }
    ...
    protected void writeUpdate() throws JspException {
        BaseTableInterface<?> table = getComponent().getTable();
        if (table != null && table.getPageSize() > 0 && table.size() > 0
                && isRowEditable(table.getCurrentRow())) {
            writeln("<span class=\"floatRight\">"
                    + getLink("", ListAction.NE_DETTAGLIO_UPDATE, UPDATE_IMG, null, null,
                            table.getCurrentPageIndex(), false, true, getMainNavTable())
                    + "</span>");
        }
    }
    ...
    protected void writeDelete() throws JspException {
        BaseTableInterface<?> table = getComponent().getTable();
        if (table != null && table.getPageSize() > 0 && table.size() > 0
                && isRowDeletable(table.getCurrentRow())) {
            writeln("<span class=\"floatRight\">"
                    + getLink("", ListAction.NE_DETTAGLIO_CONFIRM_DELETE, DELETE_IMG, null, null,
                            table.getCurrentPageIndex(), false, true, getMainNavTable())
                    + "</span>");
        }
    }
    ...
    protected void writeDetailUpdate() throws JspException {
        BaseTableInterface<?> table = getComponent().getTable();
        if (table != null && table.size() > 0 && isRowEditable(table.getCurrentRow())
                && isComponentEditable() && !modificainCorso()) {
            writeln("<span class=\"floatRight\">" + getSubmit(ListAction.NE_DETTAGLIO_UPDATE,
                    UPDATE_STYLE, "Modifica", "Modifica", table.getCurrentRowIndex(), false)
                    + "</span>");
        }
    }
    ...
    protected void writeDetailInsert() throws JspException {
        BaseTableInterface<?> table = getComponent().getTable();
        if (table != null && table.size() > 0 && isRowInsertable(table.getCurrentRow())
                && isComponentEditable() && !modificainCorso()) {
            writeln("<span class=\"floatRight\">" + getSubmit(ListAction.NE_DETTAGLIO_INSERT,
                    INSERT_STYLE, "Inserisci", "Inserisci", table.getCurrentRowIndex(), false)
                    + "</span>");
        }
    }
    ...
    protected void writeDetailDelete() throws JspException {
        BaseTableInterface<?> table = getComponent().getTable();
        if (table != null && table.size() > 0 && isRowDeletable(table.getCurrentRow())
                && isComponentEditable() && !modificainCorso()) {
            writeln("<span class=\"floatRight\">" + getSubmit(ListAction.NE_DETTAGLIO_DELETE,
                    DELETE_STYLE, "Elimina", "Elimina", table.getCurrentRowIndex(), false)
                    + "</span>");
        }
    }
    ...
    protected void writeDetailSave() throws JspException {
        ...
        if (table != null && table.getPageSize() > 0 && table.size() > 0 && modificainCorso()) {
            writeln("<span class=\"floatRight\">" + getSubmit(ListAction.NE_DETTAGLIO_SAVE,
                    SAVE_STYLE, "Salva", "Salva", table.getCurrentRowIndex(), false) + "</span>");
        }
    }
    ...
    protected void writeDetailCancel() throws JspException {
        ...
        if (table != null && table.getPageSize() > 0 && table.size() > 0 && modificainCorso()) {
            writeln("<span class=\"floatRight\">" + getSubmit(ListAction.NE_DETTAGLIO_CANCEL,
                    CANCEL_STYLE, "Annulla", "Annulla", table.getCurrentRowIndex(), false)
                    + "</span>");
        }
    }

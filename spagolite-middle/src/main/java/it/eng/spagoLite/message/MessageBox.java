...
public class MessageBox extends FrameElement implements Iterable<Message> {
    ...
    /**
     * Aggiunge messaggi {@link Message} alla propria {@link MessageBox#list} di messaggi parserizzando la stringa
     * <em>regexOracle</em> in input che deve essere del tipo <b>ERRmsg#INFmsg#WARmsg</b> dove ERR INF e WAR sono i

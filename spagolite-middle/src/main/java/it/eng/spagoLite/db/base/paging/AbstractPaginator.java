...
public abstract class AbstractPaginator implements IPaginator {
	...
	int floorCount = (int) Math
		.floor((double) llBean.getCountResultSize() / llBean.getMaxResult())
	...
	// Indice da cui parte il "blocco" di 300 record alla volta... ad esempio per
	// pagina 4, 5 e 6 il firstResult

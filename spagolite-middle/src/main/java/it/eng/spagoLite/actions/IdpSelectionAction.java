...
public class IdpSelectionAction {
	...
	/*
	 * Anche questa � un workaround perch� all'atto del logout da keycloak il logout veniva
	...
	if (paramError != null && paramError.equals("")) {
	    ...
	    // Se il discovery � disabilitato va direttamente all'idp con il registrationId

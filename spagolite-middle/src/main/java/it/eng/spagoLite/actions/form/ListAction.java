...
public abstract class ListAction<T extends Form, U extends IUser<?>> extends FormAction<T, U> {
    ...
    protected void listNavigationOnClick(String tableName, String navigationEvent, String riga, String forceReload)
        ...
        // Forzo il goback se la tabella nella lista � null .. l'utente potrebbe aver cliccato il tasto back del
        // browser
        ...
        if (navigationEvent.equalsIgnoreCase(NE_ELENCO)) {
            ...
            // invoco il lazyloading solo se � una tabella paginata e se sono alla prima riga
            ...
            // evento invocato se sto paginando dal dettaglio
            // invoco il lazyloading solo se � una tabella paginata e se sono all'ultima riga (ie. l'ultima riga della
    ...
    private boolean lazyLoadNextPage(List<?> list) throws EMFError {
        BaseTableInterface<?> table = list.getTable();
        // invoco la paginazione lazy se � una tabella paginata e se la pagina successiva non � contenuta
        // interamente
    ...
    protected boolean lazyLoadGoPage(List<?> list, int page) throws EMFError {
        ...
        if (table.getLazyListInterface() != null && // se il primo index della lista che ho in memoria � maggiore del
                                                    // primo

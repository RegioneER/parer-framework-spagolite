...
public class Tree<T extends TreeField<?>> extends BaseElements<T> {
    ...
    public Tree(Component parent, String name, String description, String title,
	    BaseTableInterface<?> table, boolean hidden, boolean checkable, boolean editable,
	    boolean draggable, boolean sorted) {
	this(parent, name, description, title, table, hidden, false, true, false, true, false, true,
		checkable, editable, draggable, sorted);
    }

    public Tree(Component parent, String name, String description, String title,
	    BaseTableInterface<?> table, boolean hidden, boolean hideCreateNodeButton,
	    boolean useDefaultCreateNodeButton, boolean hideDeleteNodeButton,
	    boolean useDefaultDeleteNodeButton, boolean hideRenameNodeButton,
	    boolean useDefaultRenameNodeButton, boolean checkable, boolean editable,
	    boolean draggable, boolean sorted) {
	this(parent, name, description, title, table, hidden, hideCreateNodeButton,
		useDefaultCreateNodeButton, hideDeleteNodeButton, useDefaultDeleteNodeButton,
		hideRenameNodeButton, useDefaultRenameNodeButton, checkable, editable, draggable,
		sorted, false);
    }
    ...
    public Tree(Component parent, String name, String description, String title,
	    ...
	    boolean useDefaultDeleteNodeButton, boolean hideRenameNodeButton,
	    boolean useDefaultRenameNodeButton, boolean checkable, boolean editable,
	    boolean draggable, boolean sorted, boolean coloredIcons, boolean activeContextMenu) {
	this(parent, name, description, title, table, hidden, hideCreateNodeButton,
		useDefaultCreateNodeButton, hideDeleteNodeButton, useDefaultDeleteNodeButton,
		hideRenameNodeButton, useDefaultRenameNodeButton, checkable, editable, draggable,
		sorted, coloredIcons, activeContextMenu, DATA_TYPES.HTML.name());
    }
    ...
    /**
     * @param hideCreateNodeButton the hideCreateNodeButton to set
     */
    ...
    /**
     * @param hideDeleteNodeButton the hideDeleteNodeButton to set
     */
    ...
    /**
     * @param hideRenameNodeButton the hideRenameNodeButton to set
     */
    ...
    /**
     * @param useDefaultCreateNodeButton the useDefaultCreateNodeButton to set
     */
    ...
    /**
     * @param useDefaultDeleteNodeButton the useDefaultDeleteNodeButton to set
     */
    ...
    /**
     * @param useDefaultRenameNodeButton the useDefaultRenameNodeButton to set
     */
    ...
    /**
     * @param coloredIcons the coloredIcons to set
     */
    ...
    /**
     * @param activeContextMenu the activeContextMenu to set
     */

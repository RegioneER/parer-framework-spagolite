...
public class List<T extends SingleValueField<?>> extends BaseElements<T> {
    ...
    public List(Component parent, String name, String description, Status status, String title,
            BaseTableInterface<?> table, boolean hidden, boolean hideDetailButton,
        ...
        this(parent, name, description, status, title, table, hidden, hideDetailButton,
                hideUpdateButton, hideDeleteButton, hideInsertButton, false, null);
    }
    ...
    public List(Component parent, String name, String description, Status status, String title,
            ...
            boolean editable) { // 12
        this(parent, name, description, status, title, table, hidden, hideDetailButton,
                hideUpdateButton, hideDeleteButton, hideInsertButton, editable, null);
    }

    public List(Component parent, String name, String description, Status status, String title,
            BaseTableInterface<?> table, boolean hidden, boolean hideDetailButton,
            boolean hideUpdateButton, boolean hideDeleteButton, boolean hideInsertButton,
            String visibilityProperty) { // 12
        this(parent, name, description, status, title, table, hidden, hideDetailButton,
                hideUpdateButton, hideDeleteButton, hideInsertButton, false, visibilityProperty,
                null, null, null);
    }
    ...
    public List(Component parent, String name, String description, Status status, String title,
            BaseTableInterface<?> table, boolean hidden, boolean hideDetailButton,
            boolean hideUpdateButton, boolean hideDeleteButton, boolean hideInsertButton,
            boolean editable, String visibilityProperty) {
        this(parent, name, description, status, title, table, hidden, hideDetailButton,
                hideUpdateButton, hideDeleteButton, hideInsertButton, editable, visibilityProperty,
                null, null, null); // 13
    }
    ...
    public List(Component parent, String name, String description, Status status, String title,
            BaseTableInterface<?> table, boolean hidden, boolean hideDetailButton,
            boolean hideUpdateButton, boolean hideDeleteButton, boolean hideInsertButton,
            boolean editable, String visibilityProperty, Boolean filterValidRecords,
            String excelFileName) { // 15
        this(parent, name, description, status, title, table, hidden, hideDetailButton,
                hideUpdateButton, hideDeleteButton, hideInsertButton, editable, visibilityProperty,
                filterValidRecords, excelFileName, null); // 13
    }
    ...
    public List(Component parent, String name, String description, Status status, String title,
            ...
            boolean hideUpdateButton, boolean hideDeleteButton, boolean hideInsertButton,
            boolean editable, String visibilityProperty, Boolean filterValidRecords,
            String excelFileName, Boolean goToPageNavigation) { // 16
     ...
     *
     * @param inTable interfaccia table
     *
                    ...
                    for (SingleValueField<?> field : this) {
                        if (!field.isReadonly() && field.isEditMode()) {
                            ...
                            if (field instanceof CheckBox || field instanceof CheckBox<?>) {
                                ...
                                row.setObject(name, ArrayUtils.contains(param, "" + index)

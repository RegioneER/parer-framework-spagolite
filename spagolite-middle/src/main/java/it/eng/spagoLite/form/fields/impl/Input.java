...
public class Input<O> extends SingleValueField<O> {
    ...
    public Input(Component parent, String name, String description, String alias, Type.Enum type,
	    String format, boolean groupingDecimal, boolean required, boolean hidden,
	    boolean readonly, boolean trigger, int maxLength, ForceCase.Enum forceCase,
	    ForceTrim.Enum forceTrim, String regExp, String tooltip) {
	...
	if (this.getType().equals(Type.DATE) && StringUtils.isNotBlank(getValue())) {
	    if (!getValue()
		    .matches("^(29/02/(2000|2400|2800|(19|2[0-9](0[48]|[2468][048]|[13579][26]))))$"

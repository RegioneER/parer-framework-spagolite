...
public class Radio<O> extends SingleValueField<O> {
    ...
    public Radio(Component parent, String name, String description, String alias, Enum type, String format,
            boolean required, boolean hidden, boolean readonly, boolean trigger, String elementGroup) {

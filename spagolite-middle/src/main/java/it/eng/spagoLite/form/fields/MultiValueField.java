...
public abstract class MultiValueField<O> extends Field {
    ...
    public MultiValueField(Component parent, String name, String description, String alias, Enum type, String format,
    ...
    public Element asXml() {
        return super.asXml().addAttribute("values", getValues() == null ? "" : getValues().toString());
    }

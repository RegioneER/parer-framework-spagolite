...
public class MultiSemaphore extends MultiValueField<String> implements IMappableField {
     ...
     * @param required      boolean true/false se obbligatorio
     * @param hidden        value
     * @param readonly      boolean true/false
     * @param trigger       boolean true/false
     * @param greenChecked  boolean true/false
     * @param yellowChecked boolean true/false
     * @param redChecked    boolean true/false
     */
    public MultiSemaphore(Component parent, String name, String description, String alias,
            it.eng.spagoLite.xmlbean.form.Field.Type.Enum type, String format, boolean required,
            boolean hidden, boolean readonly, boolean trigger, boolean greenChecked,
            boolean yellowChecked, boolean redChecked) {
    ...
    public enum State {
        ...
        GREEN(it.eng.spagoLite.xmlbean.form.Semaphore.State.GREEN, "Valido",
                "../img/sips/green.png", "V"),
        YELLOW(it.eng.spagoLite.xmlbean.form.Semaphore.State.YELLOW, "Da validare",
                "../img/sips/orange.png", "G"),
        RED(it.eng.spagoLite.xmlbean.form.Semaphore.State.RED, "Inserito", "../img/sips/red.png",
                "R");
        ...
        private State(it.eng.spagoLite.xmlbean.form.Semaphore.State.Enum enumState, String title,
                String imgUrl, String flagSemaforo) {

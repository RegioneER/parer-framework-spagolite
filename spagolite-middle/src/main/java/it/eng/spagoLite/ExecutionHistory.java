...
public class ExecutionHistory implements Serializable {
    ...
    // nome del publisher a cui la back deve rimandare in caso di forwardBackToAction
    private String publisherName;
    // eventuali parametri da mandare al publisher quando si torna in back (ad esempio il parametro table)

...
/**
 * Handler SOAP specifico per Sacer IAM (Lato SERVER): i controlli sono effettuati su tabelle
 * specifiche, che in IAM sono diverse dagli altri applicativi Viene effettuato anche il controllo

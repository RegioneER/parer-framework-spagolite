 ...
 */
public abstract class CustomSaml2AuthenticationSuccessHandler implements AuthenticationSuccessHandler {

    private static final Logger log = LoggerFactory.getLogger(CustomSaml2AuthenticationSuccessHandler.class.getName());
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        if (verificaSeUtenteSpidValido(principal, u)) {
            ...
            if (l.size() > 1) {
                 ...
                 * metto in sessione. Modifica fatta perchÃƒÂ¨ idp generici non conoscono l'id dell'utente del db di
                 * iam.
                 */
        ...
        log.info("Username: {}, id: {}, Cognome. {}, Nome: {}, email: {}", u.getUsername(), u.getIdUtente(),
                u.getCognome(), u.getNome(), u.getEmail());
    ...
    /*
     * Restituisce l'url di reindirizzamento per il login. Da ridefinire nelle classi derivate qualora il default non
     * andasse bene.
     */
    ...
    protected boolean verificaSeUtenteSpidValido(Saml2AuthenticatedPrincipal principal, User u)
        ...
        if (attributes.get(SPID_CODE) != null) {
            ...
            if (codiceFiscaleSpid != null) {
                ...
                String metodoAutenticazioneSpid = getAttribute(attributes, SPID_AUTHENTICATION_METHOD);

...
public abstract class CustomSaml2AuthenticationSuccessHandler
    ...
    protected static final String MSG_TROPPE_OCCORRENZE_UTENTE = "Gentile %s %s, non � autorizzato ad accedere ai nostri sistemi tramite utente SPID con codice fiscale %s, sono state rilevate pi� occorrenze nel database";
    protected static final String MSG_UTENTE_NON_AUTORIZZATO = "Gentile %s %s, non � autorizzato ad accedere ai nostri sistemi tramite utente SPID con codice fiscale %s";
    protected static final String MSG_UTENTE_LIVELLO_AUTH_INADEGUATO = "Gentile %s %s, non � autorizzato ad accedere ai nostri sistemi con codice fiscale %s e livello di autorizzazione %s";
    protected static final String MSG_UTENTE_SPID_NON_VALIDO = "Gentile %s %s, non � autorizzato ad accedere ai nostri sistemi con questo utente SPID senza codice fiscale";
    ...
    /*
     * Determina se un utente � un utente SPID oppure un utente proveniente da un classico IDP

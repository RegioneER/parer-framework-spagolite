...
public abstract class BaseController implements Controller, BaseControllerIFace {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (publisherInfo.getType().equals(PublisherInfo.Override.forward)) {
            ...
            if (isAuthorized(nuovaDestinazione)) {
                ...
                logger.info("Unable to forward to: " + publisherInfo.getDestination() + " user not authorized");
    ...
    protected void forwardToAction(String publisherName) {
        publisherInfo = new PublisherInfo(PublisherInfo.Override.actionForward, publisherName, null);
    }

    protected void redirectToAction(String publisherName) {
        publisherInfo = new PublisherInfo(PublisherInfo.Override.actionRedirect, publisherName, null);
    }

    protected void redirectToActionProfiled(String publisherName) {
        publisherInfo = new PublisherInfo(PublisherInfo.Override.actionProfiledRedirect, publisherName, null);
    }
    ...
    /*
     * Metodo che se ridefinito nelle classi derivate consente di tornare il nome dell'organizzazione (es. DIPS (LUM,
     * Pievesestina ecc.))
     */

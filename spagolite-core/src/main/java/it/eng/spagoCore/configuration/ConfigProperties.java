...
public class ConfigProperties {
    ...
    public enum StandardProperty {
        ...
        LOGO_APP_ALT("logoApp_alt", StringUtils.EMPTY), LOGO_APP_URL("logoApp_url", StringUtils.EMPTY),
        LOGO_APP_TITLE("logoApp_title", StringUtils.EMPTY), LOGO_1_ALT("logo1_alt", StringUtils.EMPTY),
        LOGO_1_URL("logo1_url", StringUtils.EMPTY), LOGO_1_TITLE("logo1_title", StringUtils.EMPTY),
        LOGO_2_ALT("logo2_alt", StringUtils.EMPTY), LOGO_2_URL("logo2_url", StringUtils.EMPTY),
        LOGO_2_TITLE("logo2_title", StringUtils.EMPTY), LOGO_3_ALT("logo3_alt", StringUtils.EMPTY),
        LOGO_3_URL("logo3_url", StringUtils.EMPTY), LOGO_3_TITLE("logo3_title", StringUtils.EMPTY),
        TITOLO_APPLICATIVO("titolo_applicativo", "Titolo Applicazione"), AMBIENTE("ambiente_deploy", StringUtils.EMPTY),
        ...
        PROFILER_APP_UPLOAD_DIR("profilerApp.upload.directory", System.getProperty("java.io.tmpdir")),
        ...
        LOAD_XSD_APP_UPLOAD_DIR("loadXsdApp.upload.directory", System.getProperty("java.io.tmpdir")),
        ...
        public static String[] toList() {
            return Stream.of(ConfigProperties.StandardProperty.values()).map(StandardProperty::getPropName)
                    .toArray(String[]::new);
        }
    ...
    public enum URIProperty {
        ...
        LOGO_1_RELATIVE("logo1_absolutePath", StringUtils.EMPTY, "logo1_relativePath", LOGOS_BASE_DIR + "/logo1.png",
                LOGO_1_PATH_FROM_EXT),
        LOGO_2_RELATIVE("logo2_absolutePath", StringUtils.EMPTY, "logo2_relativePath", LOGOS_BASE_DIR + "/logo2.png",
                LOGO_2_PATH_FROM_EXT),
        LOGO_3_RELATIVE("logo3_absolutePath", StringUtils.EMPTY, "logo3_relativePath", LOGOS_BASE_DIR + "/logo3.png",
                LOGO_3_PATH_FROM_EXT),
        FAV_ICON_RELATIVE("favicon_absolutePath", StringUtils.EMPTY, "favicon_relativePath", "/img/favicon.ico",
                FAV_ICON_PATH_FROM_EXT),
        CSS_OVER_RELATIVE("cssover_absolutePath", StringUtils.EMPTY, "cssover_relativePath", "/css/slForms-over.css",
                CSS_OVER_PATH_FROM_EXT);
        ...
        private URIProperty(String propAbsolutePathName, String propAbsoluteDefaultValue, String propRelativePathName,
                String propRelativeDefaultValue, String destination) {
        ...
        public static String[] toList() {
            return Stream
                    .concat(Arrays.asList(URIProperty.values()).stream().map(URIProperty::getPropAbsolutePathName),
                            Arrays.asList(URIProperty.values()).stream().map(URIProperty::getPropRelativePathName))
                    .toArray(String[]::new);
        }

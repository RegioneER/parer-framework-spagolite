...
/**
 * La classe <code>JavaScript</code> è una classe di utility che mette a disposizione dei metodi
 * statici che implementano le stesse funzionalità di alcune funzioni in javascript.
 *
 * @author Luigi Bellio
 */
public class JavaScript {
     ...
     *
     * @param input the string to manage.
     *
     * @return stringa manipolata
     */
	...
	if (replaced != null) {
		...
		newToParse += replaced;
		newToParse += toParse.substring(parameterIndex + replacing.length(),
			toParse.length());
		toParse = newToParse;

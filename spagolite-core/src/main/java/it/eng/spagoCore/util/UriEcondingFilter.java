...
public class UriEcondingFilter implements Filter {
    ...
    public void init(FilterConfig config) throws ServletException {
        ...
        if (valueSeparator == null) {
            multiValueSeparator = new String[] { ",", "\\+", "\\|" };// default
        } else {
    ...
    public class EncodedHttpWrapper extends HttpServletRequestWrapper {
        ...
        private void buildURIEncodParameterMap() throws UnsupportedEncodingException {
            ...
            if (!StringUtils.isEmpty(queryString)) {
                String decoded = URLDecoder.decode(queryString,
                        super.getCharacterEncoding() == null ? encoding : super.getCharacterEncoding());
                ...
                for (String param : params) {
                    ...
                    if (localEncoded.get(paramAndValue[PARAM]) != null) {
                        ...
                        // add on map
                        localEncoded.put(paramAndValue[PARAM], parameterValues.toArray(new String[] {}));
                    } else {
        ...
        private String[] valuesAsList(String value) {
            String[] values = new String[] { value }; // init
            ...
            try {
                ...
                values = new String[] { json.toString() };
            } catch (Exception e) {
                // if list of values try to manage them with separator (check on multiValueSeparator)

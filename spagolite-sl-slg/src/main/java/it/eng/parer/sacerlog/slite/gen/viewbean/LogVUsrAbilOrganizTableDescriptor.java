 ...
 *
 */
public class LogVUsrAbilOrganizTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Log_V_Usr_Abil_Organiz /**/";
    public static final String TABLE_NAME = "Log_V_Usr_Abil_Organiz";

...
public interface JbossJobTimer {
     ...
     *
     * @param applicationName nome dell'applicazione. Necessario per SacerLog
     */
     ...
     *
     * @param sched           espressione di schedulazione
     * @param applicationName nome dell'applicazione. Necessario per SacerLog
     */
     ...
     *
     * @param timer firma standard del metodo di timeout
     *
     * @throws java.lang.Exception eccezione generica
     */

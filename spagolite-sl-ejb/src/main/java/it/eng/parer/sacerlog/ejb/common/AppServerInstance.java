...
/**
 *
 * @author Fioravanti_F, Iacolucci_M
 */
@Singleton
@LocalBean
@Startup
public class AppServerInstance {
    ...
    private static org.slf4j.Logger LOG = LoggerFactory.getLogger(SacerLogHelper.class);
	...
	try {
	    ...
	    AplVParamApplic paramApplic = paramApplicHelper.getServerNameSystemProperty();
	    String instance = System.getProperty(paramApplic.getDsValoreParamApplic());
	    if (instance != null) {
		servername += "/" + instance;
	    }

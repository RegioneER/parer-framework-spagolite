...
public class PremisEnums {
    ...
    /*
     * public class TipoClasseEvento { public static final String CANCELLAZIONE = "CANCELLAZIONE"; public static final
     * String INSERIMENTO = "INSERIMENTO"; public static final String INSERIMENTO_MODIFICA = "INSERIMENTO_MODIFICA";
     * public static final String MODIFICA = "MODIFICA"; public static final String VISUALIZZAZIONE = "VISUALIZZAZIONE";
     * };
     */

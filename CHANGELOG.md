...
### Bugfix: 1
- [#40413](https://parermine.regione.emilia-romagna.it/issues/40413) Correzione pop-up di cancellazione di un elemento da una lista.

### Novità: 1
- [#40285](https://parermine.regione.emilia-romagna.it/issues/40285) Introduzione configurazione per aumentare la dimensione massima ammessa della somma degli attributi HEADER
...
### Novità: 1
- [#40069](https://parermine.regione.emilia-romagna.it/issues/40069) Patch di sicurezza per interventi legati a CVE

## 7.2.0 (14-01-2026)

### Novità: 2
- [#39527](https://parermine.regione.emilia-romagna.it/issues/39527) Modifica  gestione dell'autenticazione con token
- [#39247](https://parermine.regione.emilia-romagna.it/issues/39247) Dettaglio ente convenzionato: aggiunta sezione per la gestione dei documenti del processo di conservazione

## 7.1.4 (21-11-2025)

### Novità: 1
- [#39292](https://parermine.regione.emilia-romagna.it/issues/39292) Adeguamento procedura di paginazione lista per utilizzo con query native.

...
-->            
    ...
    <xsl:template match="datiRecordCancellati">
        <TABLE style="margin-left:25px" border="0" width="98%" >
            <TR>
                <TD>
                    <xsl:apply-templates select="recordFigliCancellati" />
                </TD>
            </TR>
        </TABLE>
    </xsl:template>	

    <xsl:template match="recordFigliCancellati">
        <TABLE style="margin-left:25px" border="0" width="98%" >
            <TR bgcolor="#ffad99">
                <TD>
                    Record figlio <b><xsl:value-of select="tipoRecord" /></b>
            ...
            <xsl:apply-templates select="datiCancellati" />
    ...
    <xsl:template match="datiCancellati">
            <xsl:for-each select="datoCancellato">
                <TR bgcolor="#fff5cc">
                    <TD>
                        Cancellato il dato <b>
                            <xsl:value-of select="labelDato" />
                        </b>
                        con valore <b>
                            <xsl:value-of select="valoreDato" />

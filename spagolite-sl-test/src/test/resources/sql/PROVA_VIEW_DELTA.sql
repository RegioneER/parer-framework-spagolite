...
FROM        
(
SELECT  rownum ID_DELTA_FOTO,
        oggetto_evento_attuale.id_oggetto_evento ID_OGGETTO_EVENTO_ATTUALE,
        chiave_accesso_attuale.DT_REG_EVENTO DATA_EVENTO_ATTUALE,
        oggetto_evento_prec.ID_OGGETTO_EVENTO ID_OGGETTO_EVENTO_PREC,
        chiave_accesso_prec.DT_REG_EVENTO DATA_EVENTO_PREC,
...
WHERE   oggetto_evento_attuale.id_oggetto_evento = 611
);

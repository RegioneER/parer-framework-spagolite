...
/*
    @Test
     public void d3_testDiffFotoSimulatoSoloModifiche() {
     String XML1 = "test_completo_simulato/test-simulato-completo-solo-mod-1.xml";
     String XML2 = "test_completo_simulato/test-simulato-completo-solo-mod-2.xml";
     String DELTA = "DELTA-ATTESO-simulato-completo-solo-mod.xml";
     String DELTA_ATTESO = "test_completo_simulato/" + DELTA;
     String registro_primo = leggiFile(XML1);
     String registro_secondo = leggiFile(XML2);
     boolean resultXml1 = validaXml(XML1);
...
//     Assert.assertEquals(risultatoAtteso, delta);
     ...
     @Test
     public void d3_testDiffFotoAssertSimulatoSoloModifiche() {
     String XML1 = "test_completo_simulato/test-simulato-completo-solo-mod-1.xml";
     String XML2 = "test_completo_simulato/test-simulato-completo-solo-mod-2.xml";
     String DELTA = "DELTA-ATTESO-assert-simulato-completo-solo-mod.xml";
     String DELTA_ATTESO = "test_completo_simulato/" + DELTA;
     String registro_primo = leggiFile(XML1);
     String registro_secondo = leggiFile(XML2);
     boolean resultXml1 = validaXml(XML1);
     ...
     Assert.assertTrue(resultXml1 && resultXml2);
     String risultatoAtteso = leggiFile(DELTA_ATTESO);
     String delta = sacerLogHelper.getDeltaFotoAssertAsClob(registro_primo, registro_secondo);
     log.info("DELTA {}", delta);
     scriviFile(GENERATED_DIR+"/"+DELTA, delta);
//     Assert.assertEquals(risultatoAtteso, delta);
     }
...
/*
     @Test
     public void d4_testDiffFotoSimulatoSoloRecordMaster() {
     String XML1 = "test_completo_simulato/test-simulato-completo-solo-record-master-1.xml";
     String XML2 = "test_completo_simulato/test-simulato-completo-solo-record-master-2.xml";
     String DELTA = "DELTA-ATTESO-simulato-completo-solo-record-master.xml";
     String DELTA_ATTESO = "test_completo_simulato/" + DELTA;
     String registro_primo = leggiFile(XML1);
     String registro_secondo = leggiFile(XML2);
     boolean resultXml1 = validaXml(XML1);
...
/*
    @Test
    public void testVerificaBug_DeltaFoto() {
        String XML1 = "TEST_VERIFICA_BUG/FOTO_VECCHIA.xml";
        String XML2 = "TEST_VERIFICA_BUG/FOTO_NUOVA.xml";
        String DELTA = "DELTA-ATTESO-VERIFICA_BUG.xml";
//        String DELTA_ATTESO = "test_completo_simulato/" + DELTA;
        String xml1 = leggiFile(XML1);
        String xml2 = leggiFile(XML2);
//        String risultatoAtteso = leggiFile(DELTA_ATTESO);
//        boolean resultXml1 = validaXml(XML1);
//        Assert.assertTrue(resultXml1);
//        boolean resultXml2 = validaXml(XML2);
//        Assert.assertTrue(resultXml1 && resultXml2);
        String delta = sacerLogHelper.getDeltaFotoAsClob(xml1, xml2);
        log.info("DELTA {}", delta);
        scriviFile(GENERATED_DIR + "/" + DELTA, delta);
//        Assert.assertEquals(risultatoAtteso, delta);
    }
    ...
    @Test
    public void testVerificaBug_DeltaFoto_Assert() {
        String XML1 = "TEST_VERIFICA_BUG/FOTO_VECCHIA.xml";
        String XML2 = "TEST_VERIFICA_BUG/FOTO_NUOVA.xml";
        String DELTA = "DELTA-ASSERT-ATTESO-VERIFICA_BUG.xml";
//        String DELTA_ATTESO = "test_completo_simulato/" + DELTA;
        String xml1 = leggiFile(XML1);
        String xml2 = leggiFile(XML2);
//        String risultatoAtteso = leggiFile(DELTA_ATTESO);
...
//        Assert.assertTrue(resultXml1 && resultXml2);
        try {
            String delta = sacerLogHelper.getDeltaFotoAssertAsClob(xml1, xml2);
            log.info("DELTA {}", delta);
            scriviFile(GENERATED_DIR + "/" + DELTA, delta);
        } catch (Throwable ex) {
...
/*    
    @Test
    public void d5_testDiffFotoAssertSimulatoTOTALE() {
        String XML1 = "test_completo_simulato/test-simulato-completo-TUTTO-1.xml";
        String XML2 = "test_completo_simulato/test-simulato-completo-TUTTO-2.xml";
        String DELTA_ASSERT = "DELTA-ATTESO-assert-simulato-completo-TUTTO.xml";
        String DELTA = "DELTA-ATTESO-simulato-completo-TUTTO.xml";
        String DELTA_ATTESO = "test_completo_simulato/" + DELTA;
        String registro_primo = leggiFile(XML1);
        String registro_secondo = leggiFile(XML2);
//        String risultatoAtteso = leggiFile(DELTA_ATTESO);
...
//        Assert.assertTrue(resultXml1 && resultXml2);
        String delta = sacerLogHelper.getDeltaFotoAssertAsClob(registro_primo, registro_secondo);
        log.info("DELTA ASSERT {}", delta);
        scriviFile(GENERATED_DIR + "/" + DELTA_ASSERT, delta);
        delta = sacerLogHelper.getDeltaFotoAsClob(registro_primo, registro_secondo);
        log.info("DELTA {}", delta);
        scriviFile(GENERATED_DIR + "/" + DELTA, delta);
//        Assert.assertEquals(risultatoAtteso, delta);
    }
*/
    /*
     @Test
     public void d6_testTrasformazioneHTMLDiffFotoSimulatoTOTALE() {
     String DELTA = "DELTA-ATTESO-simulato-completo-TUTTO.xml";
     String XSL = "deltaHtml.xsl";
     //      String DELTA_ATTESO = "test_completo_simulato/" + DELTA;
     //      String risultatoAtteso = leggiFile(DELTA_ATTESO);
     boolean result = trasformaInHtml("test_completo_simulato", DELTA, XSL);
     Assert.assertTrue(result);
     //        String delta = sacerLogHelper.getDeltaFotoAsClob(registro_primo, registro_secondo);
     //        log.info("DELTA {}", delta);
     //        scriviFile(DELTA, delta);
     //        Assert.assertEquals(risultatoAtteso, delta);
     }
     */
    /*    
     @Test
     public void d7_testTrasformazioneHTMLAssertDiffFotoSimulatoTOTALE() {
     String DELTA = "DELTA-ATTESO-assert-simulato-completo-TUTTO.xml";
     String XSL = "deltaAssertHtml.xsl";
     //      String DELTA_ATTESO = "test_completo_simulato/" + DELTA;
     //      String risultatoAtteso = leggiFile(DELTA_ATTESO);
     boolean result = trasformaInHtml("test_completo_simulato", DELTA, XSL);
     Assert.assertTrue(result);
    ...
    /*    
     @Test
     public void testValidazioneTestSimulatoCOMPLETO() {
     boolean resultXml1=validaXml("test_completo_simulato/test-simulato-completo-1.xml");
     Assert.assertTrue(resultXml1);
     boolean resultXml2=validaXml("test_completo_simulato/test-simulato-completo-2.xml");
     Assert.assertTrue(resultXml1 && resultXml2);
     }
     */
    ...
    public boolean trasformaInHtml(String cartellaXml, String fileXml, String fileXslt) {
        try {
            ...
            transformer.transform(text, new StreamResult(new File(locationPath + "../../src/test/resources/" + fileXml + ".html")));
            return true;
        } catch (Exception ex) {
            ex.printStackTrace();

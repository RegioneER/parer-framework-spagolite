...
/*    
    ...
    public void _chiamataAllalogBeforeEAfter() throws Exception {
        ...
        List<ObjectsToLogBefore> listaOggettiDaLoggare=sacerLog.logBefore("SACER", "admin_generale", "toolbar/delete", "Registro", new BigDecimal(19928), "/struttura/registroUnitaDocDetail" );
        sacerLog.log("SACER", "admin_generale", "toolbar/delete", "Registro", new BigDecimal(19928), "/struttura/registroUnitaDocDetail");
...
/*    
    @Test
    public void _10_InserimentoDueRecord() throws Exception {
        userTransaction.begin();
        LogEventoByScript logScript=new LogEventoByScript();
        logScript.setDtRegEvento(new Timestamp((new Date()).getTime()));
        ...
        logScript.setTiRuoloAgenteEvento("implementer");
        logScript.setTiRuoloOggettoEvento("MODIFICA");
        ...
        logScript2.setDtRegEvento(new Timestamp((new Date()).getTime()));
        ...
        logScript2.setTiRuoloAgenteEvento("implementer");
        logScript2.setTiRuoloOggettoEvento("MODIFICA");
        // Inserisce un record di script
...
//        sacerLog.log("SACER_IAM", "admin_generale", "toolbar/update", "Utente", new BigDecimal(5632), "/amministrazioneUtenti/dettaglioUtenteWizard");
        ...
        userTransaction.begin();
        sacerLogJob.allineamentoLogByScript(new BigDecimal(321));
        userTransaction.commit();
...
/*
    ...
    public void _20_chiamataAllAPIDiLoggingCONinserimentoDueRecord() throws Exception {
        userTransaction.begin();
        // Logga un evento da finestra di un utente
        List<LogEventoByScript> l=sacerLogHelper.getLogEventoScriptByTipoOggettoId(new BigDecimal(5632), new BigDecimal(46));
        sacerLog.log("SACER_IAM", "admin_generale", "toolbar/update", "Utente", new BigDecimal(5632), "/amministrazioneUtenti/dettaglioUtenteWizard");
        // cancella un record script
//        sacerLogHelper.removeEntity(logScript, true);
//        sacerLogHelper.removeEntity(logScript2, true);
...
/*    
    @Test
    public void _21_testnewTransactionId() throws Exception {
        BigDecimal id=sacerLogHelper.getNewTransactionId();
        log.info("TID [{}]", id);
        Assert.assertTrue( (id!=null && id.intValueExact()>0) );
    }
*/
...
/*    
    ...
    public void _20_chiamataAllAPIDiLoggingCONinserimentoDueRecord() throws Exception {
        userTransaction.begin();
        // Logga un evento da finestra di un utente
        List<LogEventoByScript> l=sacerLogHelper.getLogEventoScriptByTipoOggettoIdLocked(new BigDecimal(6), new BigDecimal(19116));
//        sacerLog.log("SACER_IAM", "admin_generale", "toolbar/update", "Utente", new BigDecimal(5632), "/amministrazioneUtenti/dettaglioUtenteWizard");
        // cancella un record script
//        sacerLogHelper.removeEntity(logScript, true);
//        sacerLogHelper.removeEntity(logScript2, true);
...
/*
    @Test
    public void testLogModificaDataErogazione() throws Exception {
        userTransaction.begin();
        
        sacerLog.log(sacerLog.getNewTransactionLogContext(),"SACER_IAM", "Job Calcolo contenuto Sacer", "Set data erogazione servizi", "Ente convenzionato", new BigDecimal(372), "CALCOLO_CONTENUTO_SACER");
        userTransaction.commit();
...
/*
    @Test
    public void testFindAllEventibyScript() throws Exception {
        userTransaction.begin();
        
//        sacerLog.logCompSoftware("SACER_IAM", "REPLICA_UTENTI", "Disattivazione automatica", "Utente", new BigDecimal(5000));
//        sacerLog.log("SACER_IAM", "Job Replica utenti", "Disattivazione automatica", "Utente", new BigDecimal(5000), "REPLICA_UTENTI");
//        sacerLog.logCompSoftware("SACER", "DUPLICAZIONE_CRITERI_RAGGR_AUTOMATICI", "Set criterio raggruppamento non automatico", "Criterio raggruppamento", new BigDecimal(8103));
        sacerLog.log("SACER", "Job duplicazione criteri raggruppamento automatici", "Crea criterio raggruppamento automatico per nuovo anno", "Criterio raggruppamento", new BigDecimal(8103), "DUPLICAZIONE_CRITERI_RAGGR_AUTOMATICI");
        userTransaction.commit();
        log.debug(">>>>>>>>>>>>>>>>>>> Log effettuato!");
        Assert.assertTrue(true);
    }

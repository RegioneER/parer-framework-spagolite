 ...
 * {@link JbossTimerNodeInterceptor} e si occupa di impostare la data di prossima esecuzione
 * ottenuta dal timer.
 *
 * @author Snidero_L
 */
public class JbossTimerStartInterceptor {
    ...
    /**
     * Intercettore del metodo start programmatico del timer. L'esecuzione di questo metodo avviene
     * solo nel nodo previsto dalla configurazione. Tale requisito è garantito dall'esecuzione
     * dell'interceptor {@link JbossTimerNodeInterceptor}. Imposta la data di prossima attivazione
     * <strong>dopo aver schedulato il job</strong> (invocazione del metodo startScheduled).
     *

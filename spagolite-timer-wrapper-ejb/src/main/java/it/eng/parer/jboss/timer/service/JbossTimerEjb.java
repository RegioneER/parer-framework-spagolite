...
/**
 * Service Layer. Qui sono presenti i metodi "a grana grossa" che dialogano con la tabella di
 * gestione dei job. Questa classe è pensata per essere robusta e gestire tutte le eccezioni
 * lanciate dall'helper. Il comportamento dei metodi di questa classe, come negli interceptor, è
 * diverso a seconda che l'applicazione sia in domain mode oppure in standalone mode.
 *
 * @author Snidero_L
 */
@Stateless
...
public class JbossTimerEjb {
    ...
    /**
     * Imposta, sulla tabella deputata, lo stato "INATTIVO". Entro un minuto questa informazione
     * verrà letta dal Master Timer.
     *
    ...
    /**
     * Imposta, sulla tabella deputata, lo stato "ATTIVO". Entro un minuto questa informazione verrà
     * letta dal Master Timer.
     *
     * @param jobName  nome del job
    ...
    /**
     * Imposta, sulla tabella deputata, lo stato "ESECUZIONE SINGOLA". Entro un minuto questa
     * informazione verrà letta dal Master Timer.
     *
     * @param jobName  nome del job
     * @param nodeName nome del nodo. Viene preso in considerazione solo se non nullo.
     */
    ...
    /**
     * Data di prossima attivazione del job. Risulta diversa da null solo nel caso in cui si sia
     ...
     *
     * @param nodoAssegnato definito su banca dati
     *
     * @return lista di job
     */
     ...
     * essere dei job non appartenenti a questo modulo. Se il parametro jobName non corrisponde ad
     * alcun timer viene restituito <strong>null</strong>.
     *
     * @param jobName nome del job
     *

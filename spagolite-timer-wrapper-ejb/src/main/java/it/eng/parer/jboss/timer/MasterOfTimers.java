...
/**
 * Timer che esegue il pollig dalla tabella di configurazione. Sì, il nome della classe è una
 * citazione.
 *
 * @author Snidero_L
 */
...
public class MasterOfTimers {
    ...
    /**
     * Ottieni la lista dei nomi dei job configurati sul nodo. La lista risultante comprende solo i
     * job presenti nell'applicazione e configurati su DB.
     *
    ...
    /**
     * Metodo che ogni minuto legge lo stato dei job. In modalità standalone la lista dei job sul
     * nodo risulterà sempre vuota.
     */
    @Timeout
    public void polling() {
        if (service.isStandalone()) {
    ...
    /**
     * Eseguo su chi estende {@link JbossJobTimer} il metodo indicato dallo stato del job. Marcato
     * con REQUIRES_NEW per evitare di invalidare la transazione chiamante in caso di errore.
     *
     * @param timer timer concreto che estende {@link JbossJobTimer}
     * @param job   definizione del job
     */

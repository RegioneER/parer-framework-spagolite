...
public class IAMRestClients {
     ...
     *
     * @param serviceURL,   url del servizio di helpe online
     * @param idApplic,     id applicazione per cui fornire l'help online
     * @param tiHelpOnLine, tipologia help online
     * @param nmPaginaWeb.  pagina web per cui cui richiedere l'help online
     *

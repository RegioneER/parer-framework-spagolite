...
/**
 * Contenitore dei client SOAP. Per garantire la thread safety nonostante il lazy loading vieniva
 * utilizzato il pattern di double-checked locking. Questo pattern è sbagliato per questo motivo:
...
public class IAMSoapClients {
    ...
    /**
     * Permette di sovrascrivere i valori relativi al timeout della chiamata al ws SOAP. Attualmente
     * sovrascrive tutti i valori già impostati su :
     ...
     * </pre>
     *
     * @param wsClient   client del WS SOAP
     ...
     *
     * @param <T>        Web service client type
     * @param wsClient   Istanza client web service
     * @param serviceURL url da configurare
     * @param username   username da configurare
     * @param password   password da configurare
